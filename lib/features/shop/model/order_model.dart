...
class OrderModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      // 'items': items.map((item) => item.toJson()).toList(), // Convert list of CartItemModel to JSON
    };
  }
  ...
  factory OrderModel.fromSnapshot(DocumentSnapshot snapshot) {
    ...
    return OrderModel(
      ...
      status: OrderStatus.values.firstWhere(
        ...
        orElse: () => OrderStatus.processing, // Fallback value
      ),
      ...
      //     .map((item) => CartItemModel.fromJson(item as Map<String, dynamic>)) // Assuming CartItemModel has fromJson
      //     .toList(),
    );
  }
}
